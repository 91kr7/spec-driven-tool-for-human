...
- Quando vieni ripreso con le risposte, mantieni il contesto dell'iterazione precedente: non ripartire da zero.
...
- Riprendi **lo stesso subagent** con `SendMessage` (non un nuovo Task) passandogli le risposte: così mantiene il contesto della prima iterazione.
